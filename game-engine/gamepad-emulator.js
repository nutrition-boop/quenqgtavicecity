/* Virtual gamepad (vendored from touch-controls/GamepadEmulator.js).
 * Loaded as a plain script: the bundle's ESM export is stripped, so the
 * class lands on window as `GamepadEmulator`. Also stripped: a
 * modulepreload polyfill that installed a document-wide MutationObserver.
 * Do not edit here — re-vendor from touch-controls/ instead. */
